...
<div>
  <div class="login-box-body">
    <div class="login-logo">
      <b>Tei</b>Len <small>Docentes</small>
    </div>
    ...
    <div class="row login-links">
      <div class="col-xs-12">
        <a href="/ingreso/estudiante/" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Docente">
          <div class="text-center">
            <span class="text-primary">¿Eres estudiante? Ingresa a tu plataforma aquí</span>
          </div>
        </a>
      </div>
    </div>
...
<script>
import sesion from '~/services/ingreso/docentes.js'
